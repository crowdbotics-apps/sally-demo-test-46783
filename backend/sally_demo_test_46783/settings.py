"""
Django settings for sally_demo_test_46783 project.
...
ROOT_URLCONF = 'sally_demo_test_46783.urls'
...
WSGI_APPLICATION = 'sally_demo_test_46783.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "sally_demo_test_46783 API",
    "DESCRIPTION": "API documentation for sally_demo_test_46783 App",
    "VERSION": "v1",
}
